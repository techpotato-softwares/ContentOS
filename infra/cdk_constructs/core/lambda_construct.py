...
class LambdaConstruct(Construct):
    ...
    def _create_lambda(
        ...
        environment: dict[str, str] = {
            ...
            "LINKEDIN_OIDC_SECRET_ID": config.jwt.secret_id.replace(
                "/jwt", "/linkedin-oidc"
            ),
            "LINKEDIN_OIDC_REDIRECT_URI": os.environ.get(
                "LINKEDIN_OIDC_REDIRECT_URI", ""
            ),
            "LINKEDIN_OIDC_FRONTEND_REDIRECT": os.environ.get(
                "LINKEDIN_OIDC_FRONTEND_REDIRECT", ""
            ),
        }
