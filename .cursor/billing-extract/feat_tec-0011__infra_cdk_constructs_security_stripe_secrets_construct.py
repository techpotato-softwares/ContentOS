"""Stripe secrets in Secrets Manager (test or live keys ΓÇö never commit values)."""
...
class StripeSecretsConstruct(Construct):
    ...
    def __init__(
        ...
        *,
        ...
        print(f"   ≡ƒöÉ Creating Stripe secrets for {config.environment}...")
        ...
        print(f"   Γ£à Created Stripe secret: {config.stripe.secret_id}")
