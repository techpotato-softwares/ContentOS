...
export function BillingPage() {
  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      {isLoading && <p className="text-sm text-muted-foreground">Loading billingΓÇª</p>}
      {error && (
              ...
              <div className="flex flex-wrap gap-2">
                {data.hasStripeCustomer ? (
                  ...
                  >
                    ...
                    {portalState.isLoading ? "OpeningΓÇª" : "Manage billing"}
                  </Button>
                ) : (
                  <Button
                  ...
                  >
                    ...
                    {checkoutState.isLoading ? "StartingΓÇª" : "Upgrade / subscribe"}
                  </Button>
                )}
              </div>
            </div>
