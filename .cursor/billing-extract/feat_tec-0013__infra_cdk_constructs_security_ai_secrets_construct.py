...
keys in the AWS console after the first deploy ΓÇö GenerateSecretString only
...
class AiSecretsConstruct(Construct):
    def __init__(
        ...
        *,
        ...
        print(f"   ≡ƒöÉ Creating AI secrets for {config.environment}...")
        ...
        self.secret = secretsmanager.Secret(
            ...
            description=(
                f"ContentOS platform AI credentials ({config.environment}) ΓÇö "
        ...
        print(
            f"   Γ£à Created AI secret: {config.ai_secret_id} "
