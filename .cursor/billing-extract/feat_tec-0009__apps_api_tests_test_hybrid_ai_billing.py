"""Hybrid AI billing foundation ΓÇö catalog, defaults, migration, usage events, redaction."""
...
def test_secret_redaction_strips_provider_keys():
    raw = {
        ...
        "ai_secret_arn": "arn:aws:secretsmanager:ΓÇª",
        "gemini_api_key": "AIzaSyFake",
        "nested": {"api_key": "sk-nested", "ok": True},
        "stripe_customer_id": "cus_123",  # not an API secret ΓÇö may remain if not filtered by name
    }
